<section class="antialiased bg-gray-50 text-gray-600">
    <div class="w-full mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white flex flex-col shadow-sm border border-[#D3DBEB] overflow-hidden rounded-lg transition duration-500 ease-in-out transform glow">
            <a href="<?php echo e(route('showBlogPost', $pageItem->slug)); ?>">
                <!-- Image -->
                <?php if($pageItem->media->first()): ?>
                <figure class="relative h-0 pb-[56.25%] overflow-hidden">
                    <img class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src="<?php echo e($pageItem->media->first()->getUrl('bigThumb')); ?>" alt="<?php echo e($pageItem->media->first()->custom_properties['name'] ?? ''); ?>">
...
</section><?php /**PATH C:\xampp8.1\htdocs\aicms.test\resources\views\components\post-block.blade.php ENDPATH**/ ?>