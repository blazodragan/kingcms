...
<nav class="bg-white p-4">
    <div class="container mx-auto flex items-center justify-between">
      ...
      <div class="text-white ">
        <span>
        <a href="<?php echo e(route('home')); ?>" ><img src="<?php echo e(asset('images/logo.png')); ?>" width="176px" height="66px" class="w-44" alt="Logo"></a>
      ...
      <div class="hidden md:flex space-x-10">
        ...
        <a href="<?php echo e(route('home')); ?>" class="<?php echo e(isActiveRoute('home')); ?> text-gray-700 font-medium text-lg" ><?php echo e(__('Car Rental')); ?></a>
        <a href="<?php echo e(route('showParent', ['parentSlug' => 'spanien'])); ?>" class="<?php echo e(isActiveRoute('showParent', 'spanien')); ?> text-gray-700 font-medium text-lg"><?php echo e(__('Locations')); ?></a>
        <a href="<?php echo e(route('showParent', ['parentSlug' => 'reviews'])); ?>" class="<?php echo e(isActiveRoute('showParent', 'reviews')); ?> text-gray-700 font-medium text-lg"><?php echo e(__('Vehicles')); ?></a>
        <a href="<?php echo e(route('showParent', ['parentSlug' => 'blog'])); ?>" class="<?php echo e(isActiveRoute('showParent', 'blog')); ?> text-gray-700 font-medium text-lg"><?php echo e(__('News')); ?></a>
        <a href="<?php echo e(route('showParent', ['parentSlug' => 'loyalty-program'])); ?>" class="<?php echo e(isActiveRoute('showParent', 'loyalty-program')); ?> text-gray-700 font-medium text-lg"><?php echo e(__('	Loyalty Program')); ?></a>
      </div>
      <!-- Right Side Items -->
      <div class="hidden md:flex items-center space-x-4">
        ...
        <!-- <button class="bg-cyan-600 text-white px-8 py-2 rounded-3xl font-medium"><?php echo e(__('Sign up')); ?></button>  -->
...
<div class="relative">
    ...
    <a href="<?php echo e(route('home')); ?>" class="<?php echo e(isActiveRoute('home')); ?> text-gray-700 font-medium text-lg block" ><?php echo e(__('Car Rental')); ?></a>
        <a href="<?php echo e(route('showParent', ['parentSlug' => 'spanien'])); ?>" class="<?php echo e(isActiveRoute('showParent', 'spanien')); ?> text-gray-700 font-medium text-lg block"><?php echo e(__('Locations')); ?></a>
        <a href="<?php echo e(route('showParent', ['parentSlug' => 'reviews'])); ?>" class="<?php echo e(isActiveRoute('showParent', 'reviews')); ?> text-gray-700 font-medium text-lg block"><?php echo e(__('Vehicles')); ?></a>
        <a href="<?php echo e(route('showParent', ['parentSlug' => 'blog'])); ?>" class="<?php echo e(isActiveRoute('showParent', 'blog')); ?> text-gray-700 font-medium text-lg block"><?php echo e(__('News')); ?></a>
        <a href="<?php echo e(route('showParent', ['parentSlug' => 'loyalty-program'])); ?>" class="<?php echo e(isActiveRoute('showParent', 'loyalty-program')); ?> text-gray-700 font-medium text-lg block"><?php echo e(__('	Loyalty Program')); ?></a>
    </div>
  </nav>
  <?php /**PATH C:\xampp8.1\htdocs\aicms.test\resources\views/nav.blade.php ENDPATH**/ ?>