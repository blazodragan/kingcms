...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.seo','data' => ['title' => $user->name ?: $user->title ?: $settings->default_siteTitle[app()->getLocale()],'description' => $user->meta_description ?: $settings->default_siteDescription[app()->getLocale()],'titleog' => $user->og_title ?: $user->title ?: $settings->default_siteTitle[app()->getLocale()],'imageog' => $user->avatar_url ?: $user->profile_photo_url ?: asset('images/logo.png')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user->name ?: $user->title ?: $settings->default_siteTitle[app()->getLocale()]),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user->meta_description ?: $settings->default_siteDescription[app()->getLocale()]),'titleog' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user->og_title ?: $user->title ?: $settings->default_siteTitle[app()->getLocale()]),'imageog' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user->avatar_url ?: $user->profile_photo_url ?: asset('images/logo.png'))]); ?>
