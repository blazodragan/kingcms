...
<?php endif; ?>
<?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.logo-schema','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('logo-schema'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
  ...
  <section>
    ...
    <div class="w-full 2xl:w-2/3 mx-auto bg-white rounded lg:flex flex-col lg:flex-row"> <!-- Container Box -->
          ...
          <div class="flex-grow mb-10 p-10 border-r sm:mb-0 relative" style="flex-basis: 70%;">
            <img src="<?php echo e(asset('images/bitmap.png')); ?>" width="294px" height="222px" alt="Under Construction" class="absolute top-0 right-0 z-20">
            <div class="transparent-white-overlay z-10">
            

                        <h3 class="text-2xl mb-4 text-site-blue-dark text-left"><?php echo e(__('Reserve a Vehicle')); ?></h3>
            <form>
              <div class="flex items-center relative w-full mb-4">
                <input type="name" class="w-full p-3 rounded-l-lg border pl-12" placeholder="<?php echo e(__('Pick up location')); ?>" disabled>
                ...
                <div class="flex items-center relative w-1/2 mb-4">
                  <input type="name" class="w-full p-3 rounded-l-lg border border-r-0 pl-12" placeholder="<?php echo e(__('Pick up date')); ?>" disabled>
                ...
                <!-- Pick up time -->
                <div class="flex items-center relative w-1/2 mb-4 ">
                  <input type="name" class="w-full p-3 rounded-r-lg border pl-12" placeholder="<?php echo e(__('Time')); ?>" disabled>
                ...
                <div class="w-full basis-1/2 flex">
                  <div class="flex items-center relative w-1/2 mb-4">
                    <input type="name" class="w-full p-3 rounded-l-lg border border-r-0 pl-12" placeholder="<?php echo e(__('Drop Off Date')); ?>" disabled>
          ...
          <div class="flex-grow p-10 " style="flex-basis: 40%;">
            <h3 class="text-xl mb-4 text-site-blue-dark text-left"><?php echo e(__('Advantages of Hiring with MietwegenParadise')); ?></h3>
            <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
              ...
              <li class="flex items-center">
                  <svg class="w-3.5 h-3.5 mr-2 text-[#12B0DF] flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 448 512">
                   ...
                   <?php echo e(__('Compare hundreds of rental car websites at once for car rental deals in Utrecht')); ?>
              ...
              <li class="flex items-center">
                  <svg class="w-3.5 h-3.5 mr-2 text-[#12B0DF]  flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 448 512">
                   ...
                   <?php echo e(__('We are completely free to use . There are no hidden costs or fees')); ?>
              ...
              <li class="flex items-center">
                <svg class="w-3.5 h-3.5 mr-2 text-[#12B0DF] flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 448 512">
                 ...
                 <?php echo e(__('Filter by car type, free cencelation and more')); ?>
...
<?php echo app(App\Services\BlockResolver::class)->resolve('ChildPagesBlock', ['count' => 3, 'parent_id' => '17']); ?>
</div>
</div>
  
  <!-- Snippet -->
  <div class="text-4xl mt-10 text-site-blue-dark text-center"><?php echo e(__('Meet The Fleet')); ?></div>
  <section class="block bg-white text-gray-600 relative h-1/3 min-h-[450px] p-12">
    ...
    <div class=" item active">
                ...
                <a href="#" aria-label="2023 Porsche Panamera">
                  ...
                  <img src="<?php echo e(asset('images/2023_Porsche_Panamera.png')); ?>" alt="2023 Porsche Panamera" class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out">
      ...
      <div class="item next">
        ...
        <div
          ...
          <a href="#" aria-label="Minivan">
            <!-- Image -->
            <figure class="relative h-0 pb-[56.25%] overflow-hidden mt-5">
            <img src="<?php echo e(asset('images/minivan.png')); ?>" alt="Minivan" class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out">
      ...
      <div class="item">
        ...
        <a href="#" aria-label="Polo">
          <!-- Image -->
          <figure class="relative h-0 pb-[56.25%] overflow-hidden mt-5">
          <img src="<?php echo e(asset('images/polo.png')); ?>" alt="Polo" class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out">
      ...
      <div class="item">
                ...
                <a href="#" aria-label="E-tron">
                  <!-- Image -->
                  <figure class="relative h-0 pb-[56.25%] overflow-hidden mt-5">
                  <img src="<?php echo e(asset('images/e-tron.png')); ?>" alt="E-tron" class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out">
      ...
      <div class="item prev">
                ...
                <a href="#" aria-label="Jeta">
                  <!-- Image -->
                  <figure class="relative h-0 pb-[56.25%] overflow-hidden mt-5">
                  <img src="<?php echo e(asset('images/jeta.png')); ?>" alt="Jeta" class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out">
...
<div class="w-full pt-10 pb-10 bg-gray-50">
<div class="w-4/5 sm:w-full 2xl:w-3/5 mx-auto bodycontent">
<?php echo app(App\Services\BlockResolver::class)->resolve('ReviewsBlock', ['count' => 3]); ?>
</div>
</div>
<!-- say about us-->
<!-- Snippet -->
<div class="text-4xl mt-10 text-site-blue-dark text-center"><?php echo e(__('What customers say about us')); ?></div>
<div class="text-1xl mt-2 text-gray-500 text-center"><?php echo e(__('We do our best to provide you with the best expiriance')); ?></div>
  ...
  <div class="wrapper w-[15rem] md:w-[30rem] lg:w-[60rem]">
    ...
    <div class="card bg-white w-60 px-2">
        ...
        <g id="rean-a-car">
          ...
          <h2 class="text-black font-bold text-left"><?php echo e($review->title); ?></h2>
        ...
        <img src="<?php echo e(asset('images/stars-' . $roundedRating . '.svg')); ?>" alt="<?php echo e($roundedRating); ?> Stars" class="w-24 mr-2">



            </div>
            <div class="text-xs align-middles"><?php echo e($review->created_at->diffForHumans()); ?></div>
          </div>
          <div class="text-left text-sm"><?php echo e($review->description); ?></div>
        </div>
      </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8.1\htdocs\aicms.test\resources\views\welcome.blade.php ENDPATH**/ ?>