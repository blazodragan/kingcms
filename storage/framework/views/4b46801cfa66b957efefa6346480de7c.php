...
<section>
    <div class="bg-search-welcome bg-no-repeat  bg-cover w-full p-5"> <!-- Hero Section -->
        ...
        <div class="flex justify-center items-center text-sm mt-2 text-white space-x-3">
            ...
            <span>Updated on <?php echo e(date('F Y, d', strtotime($page->published_at))); ?>
        ...
        <div class="w-full lg:w-2/6 p-4 ">
            <div class="rounded-lg overflow-hidden shadow">
                ...
                <div class="p-12 flex-col">
                    ...
                    <?php $__currentLoopData = $page->tips->where('type', 'suggestion'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8.1\htdocs\aicms.test\resources\views/pages/ChildTwoColumns.blade.php ENDPATH**/ ?>