...
<?php $__env->startSection('title', $post->title ?? 'Default Title'); ?>
...
<section>
    <div class="bg-search-welcome bg-no-repeat  bg-cover w-full p-5"> <!-- Hero Section -->
        <div class="w-full xl:w-1/2 mx-auto m-auto text-center flex"> <!-- Container Box -->
            <h1 class="text-2xl w-full text-white"><?php echo e(__('Blog Post')); ?></h1>
        </div>
    </div>
</section>
<section class="antialiased bg-white  p-10">
    <h1 class="text-4xl mb-10 text-site-blue-dark text-center"><?php echo e($post->title); ?></h1>
    ...
    <img class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src="<?php echo e($post->media->first()->getUrl()); ?>" alt="<?php echo e($post->media->first()->custom_properties['name'] ?? ''); ?>">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8.1\htdocs\aicms.test\resources\views\posts\show.blade.php ENDPATH**/ ?>