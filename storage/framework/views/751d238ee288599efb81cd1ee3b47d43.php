...
<section class="antialiased bg-white  p-10">
    ...
    <img class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src="<?php echo e($review->media->first()->getUrl()); ?>" alt="<?php echo e($review->media->first()->custom_properties['alt'] ?? ''); ?>">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8.1\htdocs\aicms.test\resources\views\review\oneColumn.blade.php ENDPATH**/ ?>