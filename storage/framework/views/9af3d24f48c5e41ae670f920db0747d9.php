        ...
        <div class="w-full lg:w-2/6 p-4 ">
            <div class="rounded-lg overflow-hidden shadow">
                ...
                <div class="p-12 flex-col">
                    <?php if($page && $page->tips->count() > 0): ?>
                    <?php $__currentLoopData = $page->tips->where('type', 'why'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
...
<?php if($page && $page->tips->where('type', 'usefultip')->count() > 0): ?>
<section class="antialiased bg-site-bg-gray p-10">
    <div class="w-4/5 sm:w-full 2xl:w-3/5 mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        <?php $__currentLoopData = $page->tips->where('type', 'usefultip'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<section class="antialiased bg-gray-50  p-12">
    ...
    <img class="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src="<?php echo e($page->media->first()->getUrl()); ?>" alt="<?php echo e($page->media->first()->custom_properties['name'] ?? ''); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8.1\htdocs\aicms.test\resources\views/review/twoColumns.blade.php ENDPATH**/ ?>