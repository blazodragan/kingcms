  ...
  <PageContent>
    ...
    <template #actions>
      ...
      <template #tableRow="{ item, action }: any">
        ...
        <ListingDataCell>
            <Publish :publishedAt="item.published_at" :updateUrl="route('news.update', item.id)" columnName="published_at" mode="dateTime"/>
        </ListingDataCell>
            ...
            <Modal type="danger">
              ...
              <template #buttons="{ setIsOpen }">
                <Button
                  @click.prevent="
                    () => {
                      action('delete', route('news.destroy', item), {
                        onFinish: () => setIsOpen(false),
                      });
                    }
                  "
